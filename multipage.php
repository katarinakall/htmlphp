...
$pages = [
    ...
    "server-info" => [
        "title" =>"Information about the content in the \$_SERVER array",
        "file" => __DIR__ . "/$base/server-info.php",
    ],
    "server-list" => [
        "title" =>"The lenght of each values in the \$_SERVER array",
        "file" => __DIR__ . "/$base/server-list.php",
    ],
];
